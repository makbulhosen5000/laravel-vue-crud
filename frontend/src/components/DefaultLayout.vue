...
const user = reactive({
  name:'Makbul',
  email:'makbulhosen5000@gmail.com',
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
              <div class="shrink-0">
                <img class="size-8" src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500" alt="Lara Vue CRUD" title="Lara Vue CRUD" />
              </div>
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                  ...
                  :key="item.name" 
                  :to="item.to" 
                  :class="[$route.name === item.to.name ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-yellow-600 hover:text-white', 'rounded-md px-3 py-2 text-sm font-medium']" 
